import { TestAccountType } from "../hooks/useTestAccount";

export type TestWorkspaceNavItem = {
  label: string;
  pageTitle: string;
  subtitle: string;
  to: string;
...
export const sharedWorkspaceLinks: TestWorkspaceNavItem[] = [
  {
...
export const candidateWorkspaceLinks: TestWorkspaceNavItem[] = [
  {
    label: "Offres",
    pageTitle: "Offres",
...
export const companyWorkspaceLinks: TestWorkspaceNavItem[] = [
  {
    label: "Mes offres",
...
export function formatAccountType(value: TestAccountType) {
  if (value === "candidate") return "Candidat";
  if (value === "company") return "Entreprise";
  return "Compte";
}

export function getTestWorkspaceLinks(accountType: TestAccountType) {
...
export function getPageMeta(pathname: string, accountType: TestAccountType) {
  const links = getTestWorkspaceLinks(accountType);
...
export function getDashboardMetrics(accountType: TestAccountType): TestMetric[] {
  if (accountType === "candidate") {
    return [
